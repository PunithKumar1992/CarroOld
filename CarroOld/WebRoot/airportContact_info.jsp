  ...
  <div class="container">
	<div class="row">
        <div class="col-md-12" style="margin-left: 25%;width: 40%;margin-top:15%">
            <form action="AirportContactServlet" method="post" id="fileForm" role="form">
            <fieldset><legend class="text-center">CONTACT DETAILS<span class="req"></span></legend>
               <div class="form-group"> 	 
                <label for="firstname"><span class="req">* </span> Full name: </label>
                    <input class="form-control" type="text" name="air_fullname" id = "txt" onkeyup = "Validate(this)" required /> 
                        <div id="errFirst"></div>    
            </div>
			 <div class="form-group">
                <label for="email"><span class="req">* </span> Email Address: </label> 
                    <input class="form-control" required type="text" name="air_email" id = "email"  onchange="email_validate(this.value);" />   
                        <div class="status" id="status"></div>
            </div>
            <div class="form-group">
			
            <label for="phonenumber"><span class="req">* </span> Phone Number: </label>
                    <input required type="text" name="air_phonenumber" id="air_phone" class="form-control phone" maxlength="28" onkeyup="validatephone(this);" placeholder="not used for marketing"/> 
            </div>
           
		<input type='hidden' name='air_distance' id='distance'  value=''/>
            <div class="form-group">
...
String source= session.getAttribute("air_pick").toString();
String destination= session.getAttribute("air_destination").toString();
